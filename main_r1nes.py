...
def run(args):
    ...
    is_improving, validation_nondom_list, best_f_list = validate_one_epoch(args, agent, encoder, policy, validation_nondom_list, best_f_list, validation_dataset_list, writer, test_batch, sample_solutions, -1)  
    epoch = last_epoch
