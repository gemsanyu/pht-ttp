...
def decode_mp(test_batch, title, weight_idx, total_weight):
    ...
    tour_list, item_selection, tour_length, total_profit, travel_cost, total_cost, logprob, sum_entropies = solve_decode_only(agent, device, test_env, static_embeddings, fixed_context,glimpse_K_static, glimpse_V_static, logits_K_static)
